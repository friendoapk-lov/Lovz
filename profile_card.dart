...
class _SwipeIndicator {
  ...
  final Color color;
  final String label;
  _SwipeIndicator({required this.icon, required this.color, required this.label});
}
...
class _ProfileCardState extends State<ProfileCard> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(ProfileCard oldWidget) {
    ...
    if (widget.percentThresholdX.abs() > 15 || widget.percentThresholdY.abs() > 15) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              if (indicator != null)
                BoxShadow(
                  color: indicator.color.withOpacity(0.3 + (_borderAnimation.value * 0.4)),
            ...
            border: indicator != null
                ? Border.all(
                    color: indicator.color.withOpacity(0.4 + (_borderAnimation.value * 0.4)),
    ...
    return Stack(
      ...
      children: [
        ...
        (imageList.first != 'placeholder')
            ? CachedNetworkImage(
                imageUrl: 'https://pub-20b75325021441f58867571ca62aa1aa.r2.dev/${imageList[_currentImageIndex]}_medium.webp',
                fit: BoxFit.cover,
  ...
  // ============================================
  Widget _buildDraggableDetailsSheet(ThemeData theme, CustomColors customColors) {
  ...
  // ============================================
  _SwipeIndicator? _getSwipeIndicator(ThemeData theme, CustomColors customColors) {
